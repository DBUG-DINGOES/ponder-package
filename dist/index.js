...
`;function f({colors:e=["#22333B","#FF6F61","#B7AEA3"]}){const t=Array.from({length:e.length});return r.default.createElement(p,{xmlns:"http://www.w3.org/2000/svg",width:"150",height:"150",viewBox:"0 0 100 100",fill:"none"},t.map(((t,a)=>r.default.createElement(c,{cx:20*(a+1),cy:"49.5",r:"8",fill:e[a],key:a}))))}f.propTypes={colors:l.default.arrayOf(l.default.string),duration:l.default.string};const u=a.keyframes`
  0%, 50%, 100% {
